...
//             decoration: BoxDecoration(
//               color: Colors.transparent, // Optional: Set background color
//               border: Border.all(
//                 color: isActive
//                     ? Colors.green
//                     : Colors.red, // Green if active, red if inactive
//                 width: 2.0, // Adjust border width as needed
//               ),
//               borderRadius: BorderRadius.circular(5.0), // Round corners
//             ),
//             child: Text(
...
//                 color: isActive
//                     ? Colors.green
//                     : Colors.red, // Text color matches status
//               ),
//             ),
//           ),
//         ],
